    ...
    render(y, m) {
        ...
        <div class="calendar noselect p-5">
            <div class="month-year-btn d-flex justify-content-center align-items-center mb-2">
                <a class="prev-month" style="color:white;"><i class="fas fa-caret-left fa-lg m-3"></i></a>
                ...
                <a class="next-month" style="color:white;"><i class="fas fa-caret-right fa-lg m-3" aria-hidden="true"></i></a>
            </div>
            <ol class="day-names list-unstyled" style="text-align: center">
                <li><h4 class="initials">Sun</h4></li>
                <li><h4 class="initials">Mon</h4></li>
                <li><h4 class="initials">Tue</h4></li>
                <li><h4 class="initials">Wed</h4></li>
                <li><h4 class="initials">Thu</h4></li>
                <li><h4 class="initials">Fri</h4></li>
                <li><h4 class="initials">Sat</h4></li>
            </ol>
        </div>
        `);
        ...
        for(let i=0; i<5; i++){ //loop thru 35 boxes on the calendar month
            ...
            <ol class="days list-unstyled" style="text-align: center" week="${d.week()}">
                <li class="${d.add(1,'d'),this.m != d.month()?' outside':'inside'}${isSameDate(d,now)?' today':''}">
                    <div month="${d.month()}" class="date">${d.format('D')}</div>
                    <div class="events" style="text-align: left"></div>
                </li>
                <li class="${d.add(1,'d'),this.m != d.month()?' outside':'inside'}${isSameDate(d,now)?' today':''}">
                    <div month="${d.month()}" class="date">${d.format('D')}</div>
                    <div class="events" style="text-align: left"></div>
